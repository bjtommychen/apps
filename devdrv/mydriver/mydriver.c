...
static char * work_buffer;  /*��ָ������Ϊ���������豸�����ڴ�ռ�*/
...
static int __init  device_init(void)  /*�Ǽ��豸����,insmodʱ����*/
{
    int num;
...
#ifdef AUTO_MKNOD
    num = register_chrdev(0 /*0*/,"mydriver",&fops); /*ϵͳ�Զ�����һ��δ��ռ�õ��豸��*/
...
static void __exit  device_exit(void)  /*�ͷ��豸����,rmmodʱ����*/
{

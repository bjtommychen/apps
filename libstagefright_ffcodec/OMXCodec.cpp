...
#include "include/MP3Decoder_tommy.h"			//tommy
#include "include/FF_Codec.h"		//tommy
...
FACTORY_CREATE(MP3DecoderTommy)		//tommy
FACTORY_CREATE(FF_CODEC)					//tommy
...
static sp<MediaSource> InstantiateSoftwareCodec(
    ...
    static const FactoryInfo kFactoryInfo[] = {
        ...
        FACTORY_REF(MP3DecoderTommy)	//tommy
        FACTORY_REF(FF_CODEC)				//tommy
...
//    { MEDIA_MIMETYPE_VIDEO_MPEG4, "OMX.PV.mpeg4dec" },
    ...
    { MEDIA_MIMETYPE_VIDEO_H263, "FF_CODEC" },				//Tommy: add it here.
    { MEDIA_MIMETYPE_VIDEO_H263, "M4vH263Decoder" },		//Tommy: add it here.
...
//    { MEDIA_MIMETYPE_VIDEO_H263, "OMX.PV.h263dec" },
    ...
    { MEDIA_MIMETYPE_VIDEO_AVC, "OMX.TI.Video.Decoder" },
    { MEDIA_MIMETYPE_VIDEO_AVC, "FF_CODEC" },				//Tommy: add it here.
